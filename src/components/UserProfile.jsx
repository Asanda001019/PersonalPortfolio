...
const UserProfile = () => {
  ...
  <li>
    <Link to="/resume" className="flex items-center gap-2 cursor-pointer group">
  ...
  <li>
    <Link to="/skills" className="flex items-center gap-2 cursor-pointer group">
    <svg xmlns="http://www.w3.org/2000/svg" width="5" height="20" viewBox="0 0 5 20" fill="none">
    <path d="M4.12567 1.13672L1 18.8633" stroke="#E5E7EB" strokeWidth="1.0" strokeLinecap="round" />
    </svg>
  ...
  <li>
    <Link to="/projects" className="flex items-center gap-2 cursor-pointer group">
    <svg xmlns="http://www.w3.org/2000/svg" width="5" height="20" viewBox="0 0 5 20" fill="none">
    <path d="M4.12567 1.13672L1 18.8633" stroke="#E5E7EB" strokeWidth="1.0" strokeLinecap="round" />
    </svg>
  ...
  <li>
    <Link to="/assessments" className="flex items-center gap-2 cursor-pointer group">
    <svg xmlns="http://www.w3.org/2000/svg" width="5" height="20" viewBox="0 0 5 20" fill="none">
    <path d="M4.12567 1.13672L1 18.8633" stroke="#E5E7EB" strokeWidth="1.0" strokeLinecap="round" />
    </svg>
  ...
  <li>
    <Link to="/goals" className="flex items-center gap-2 cursor-pointer group">
        <svg xmlns="http://www.w3.org/2000/svg" width="5" height="20" viewBox="0 0 5 20" fill="none">
    <path d="M4.12567 1.13672L1 18.8633" stroke="#E5E7EB" strokeWidth="1.0" strokeLinecap="round" />
    </svg>
